...
namespace Blog4.Controllers
{
    public class MensagemsController : Controller
    {
        ...
        public MensagemsController(Blog4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Descricao,DataDeCriacao,Categoria")] Mensagem mensagem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Descricao,DataDeCriacao,Categoria")] Mensagem mensagem)
        {
            if (id != mensagem.Id)
            {
                return NotFound();
